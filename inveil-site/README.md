...
Nginx for **inveil.net** is managed by Qadbak (`website.json` → single `qadbak-customer-inveil_net.conf`). The deploy script removes any legacy `inveil.net.conf` vhost automatically.
